...
with open('cls/tools/plot/CIFAR10_S.npy','rb') as f:
    Ss = np.load(f)
with open('cls/tools/plot/CIFAR10_rank.npy','rb') as f:
    ranks = np.load(f)
...
# plt.show()
plt.tight_layout()
plt.savefig("Singular Value_CIFAR10.pdf")
...
plt.xscale("symlog")
plt.tight_layout()
plt.savefig("Effective rank_CIFAR10.pdf")